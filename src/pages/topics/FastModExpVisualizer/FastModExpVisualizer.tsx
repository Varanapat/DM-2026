  ...
  return (
    <TopicPageStack>
      <DefinitionCard
        ...
        note={
          <>
            การหา <code>a^b mod n</code> อย่างรวดเร็วด้วยการยกกำลังสองซ้ำ ๆ (binary exponentiation) แทนการคูณทีละครั้ง
            ลองนึกภาพแตกเลขชี้กำลัง <code>b</code> เป็นเลขฐานสอง แล้วยกกำลังสองผลคูณต่อเนื่อง คูณเข้าเฉพาะตอนที่ bit เป็น 1 —{' '}
            <strong>ใช้ขั้นตอนแค่ประมาณ log₂(b)</strong> แทนที่จะเป็น b ครั้ง
          </>
        }
      />
      <VisualizerFrame
