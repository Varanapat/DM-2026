  ...
  return (
    <TopicPageStack>
      <DefinitionCard
        formula={
          <>
            lcm(<b>a</b>, <b>b</b>) = (<b>a</b> × <b>b</b>) / gcd(<b>a</b>, <b>b</b>)
          </>
        }
        note={
          <>
            ตัวคูณร่วมน้อย (LCM) คือจำนวนน้อยที่สุดที่เป็นตัวคูณร่วมของทั้งสองตัว ลองนึกภาพรถเมล์สองสายออกจากป้ายพร้อมกันตอนนาทีที่ 0
            สายแรกออกทุก <code>a</code> นาที สายที่สองออกทุก <code>b</code> นาที — ครั้งถัดไปที่ทั้งสองสายจะ<strong>ออกพร้อมกัน</strong>
            อีกครั้งคือนาทีที่ lcm(a, b)
          </>
        }
      />
      <VisualizerFrame
