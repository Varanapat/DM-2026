...
export const TOPIC_CONTENT: Record<string, TopicContent> = {
  ...
  primes: {
    coreConceptTh:
      'จำนวนเฉพาะ (Prime Number) คือจำนวนเต็มบวกที่มากกว่า 1 และมีตัวหารที่เป็นบวกหรือตัวประกอบเพียง 2 ตัวเท่านั้น คือ 1 และตัวมันเอง หากไม่มีจำนวนเต็มใดตั้งแต่ 2 ถึง √n ที่หาร n ลงตัว แปลว่า n จะไม่มีตัวหารอื่นอีกเลย นอกจาก 1 และตัวมันเอง',
  ...
  'check-digits': {
    coreConceptTh:
      'เลขตรวจสอบ (Check Digit) คือตัวเลขหนึ่งหลัก (หรือตัวอักษร) ที่คำนวณขึ้นจากชุดตัวเลขหลักอื่น ๆ ก่อนหน้า เพื่อใช้ตรวจสอบความถูกต้องของข้อมูลและป้องกันความผิดพลาดจากการคีย์ข้อมูลผิด ลองนึกภาพบาร์โค้ด UPC เอาหลักคี่คูณ 3 หลักคู่คูณ 1 แล้วบวกกันทั้งหมด ถ้าผลรวม mod 10 ไม่เท่ากับเลขตรวจสอบ แปลว่าพิมพ์เลขผิดที่ไหนสักที่แน่นอน',
